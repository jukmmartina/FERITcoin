...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/feritcoin/feritcoin/pull/10340, but that change has been
    // postponed until after https://github.com/feritcoin/feritcoin/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-feritcoin-address
 ...
 * https://feritcointalk.org/?topic=54527, or
 * https://github.com/feritcoin/feritcoin/pull/1393.
 */
