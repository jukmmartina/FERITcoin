...
#ifndef FERITCOIN_WALLET_WALLET_H
#define FERITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this feritcoin node, and set to 0 for transactions that were created
...
#endif // FERITCOIN_WALLET_WALLET_H
