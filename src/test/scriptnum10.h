...
#ifndef FERITCOIN_TEST_SCRIPTNUM10_H
#define FERITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Feritcoin Core 0.10.0, for cross-comparison.
 */
public:
