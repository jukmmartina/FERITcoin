...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FeritcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_feritcoin-qt -platform xcb      # Linux
//     src/qt/test/test_feritcoin-qt -platform windows  # Windows
//     src/qt/test/test_feritcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FeritcoinUnits::formatWithUnit(unit, balance, false, FeritcoinUnits::separatorAlways);
    ...
    // Amount input
    FeritcoinAmountField* amountInput = receiveCoinsDialog.findChild<FeritcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: feritcoin:")) != -1);
