...
#ifndef FERITCOIN_QT_FERITCOINUNITS_H
#define FERITCOIN_QT_FERITCOINUNITS_H
...
/** Feritcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FeritcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FeritcoinUnits(QObject *parent);

    /** Feritcoin units.
      @note Source: https://en.feritcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FRT,
...
typedef FeritcoinUnits::Unit FeritcoinUnit;

#endif // FERITCOIN_QT_FERITCOINUNITS_H
