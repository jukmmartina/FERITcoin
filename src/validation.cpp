...
#if defined(NDEBUG)
# error "Feritcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Feritcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FRT additional fees, %d delta bytes\n",
...
{
    //premine if there are less that 10 coins
    if (nHeight < 10){
...
void ThreadScriptCheck() {
    RenameThread("feritcoin-scriptch");
