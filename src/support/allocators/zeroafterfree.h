...
#ifndef FERITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define FERITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // FERITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
