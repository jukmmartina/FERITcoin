...
# TestNode: A peer we use to send messages to feritcoind, and store responses.
...
class CompactBlocksTest(FeritcoinTestFramework):
    ...
    # This test actually causes feritcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that feritcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for feritcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # feritcoind will not send blocktxn responses for blocks whose height is
