...
By default, feritcoind will dump mempool on shutdown and
...
class MempoolPersistTest(FeritcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give feritcoind a second to reload the mempool
        ...
        self.log.debug("Prevent feritcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
