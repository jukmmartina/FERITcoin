Feritcoin Core version 0.16.1 is now available from:

  <https://feritcoincore.org/bin/feritcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting feritcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure feritcoind processes are cleaned up when tests end (sdaftuar)
