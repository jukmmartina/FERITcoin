...
This document provides guidelines for internationalization of the Feritcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `feritcoin_en.ts` remains unchanged.
