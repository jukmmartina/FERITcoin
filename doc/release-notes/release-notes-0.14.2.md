Feritcoin Core version 0.14.2 is now available from:

  <https://feritcoin.org/bin/feritcoin-core-0.14.2/>
...
(in Feritcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Feritcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate feritcoin-config.h as necessary (theuni)
