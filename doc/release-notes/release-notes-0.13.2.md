Feritcoin Core version 0.13.2 is now available from:

  <https://feritcoin.org/bin/feritcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update feritcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow feritcoin-tx to create v2 transactions (btcdrak)
