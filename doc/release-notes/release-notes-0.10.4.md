Feritcoin Core version 0.10.4 is now available from:

  <https://feritcoin.org/bin/feritcoin-core-0.10.4/>
...
- #6953 `43c2789` Split feritcoin-tx into its own package
- #6953 `dfe0d4d` Include feritcoin-tx binary on Debian/Ubuntu
