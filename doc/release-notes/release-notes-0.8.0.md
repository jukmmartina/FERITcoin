Feritcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/feritcoin/files/Feritcoin/feritcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Feritcoin
...
New/changed settings (command-line or feritcoin.conf file)
--------------------------------------------------------
