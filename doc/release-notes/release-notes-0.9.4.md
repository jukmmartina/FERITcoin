Feritcoin Core version 0.9.4 is now available from:

  https://feritcoin.org/bin/0.9.4/
...
this update is incompatible with the Feritcoin system and could lead to consensus
forks.

Feritcoin Core released binaries from https://feritcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~feritcoin/+archive/ubuntu/feritcoin
- A third-party or self-compiled Feritcoin Core

upgrade to Feritcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
